...
$(function(){
	//슬라이드배너을 감싸고 있는 오브젝트의 이름, 이 오브젝트의 넓이가 슬라이드배너의 넓이가 됨.
	var obj_wrap=$(".slideBanner2");
	//움직일 오브젝트의 이름
	var obj_name = $(".slideBanner2 ul");
	//보여질 실제 슬라이드배너을 감싸고 있는 영역
	var obj_child = $(".slideBanner2 ul li");
	...
	//슬라이드배너 컨트롤버튼
	var ctrl_btn = true;//사용여부 (true, false)
	var ctrl_next = $(".slideBanner2 .next");
	var ctrl_prev = $(".slideBanner2 .prev");
	var ctrl_stop = $(".slideBanner2 .stop");
	var ctrl_play = $(".slideBanner2 .play");

	//현재슬라이드배너 번호 / 전체 슬라이드배너번호
	var numbering = true;//사용여부 (true, false)
	var curr_num = $(".slideBanner2 .curr_num");
	var total_num = $(".slideBanner .total_num");

	//슬라이드배너 리스트
	var paging = true;//사용여부 (true, false)
	var paging_obj = $(".slideBanner2 .paging button");
	var paging_curr_class = "active";//현재 선택된 슬라이드배너을 표시할 class명
	var paging_index;//클릭한 오브젝트

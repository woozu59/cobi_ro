window.onload=function(){
    ...
    const error_li = document.querySelector('fieldset ul li');

    console.log(pw_show_hide, input_id, input_pw, id_error, pw_error, error_li);


    input_id.addEventListener('click',function(){
        id_error.style.display = 'block';
        error_li.style.borderBottom = '2px solid #e7223d'
